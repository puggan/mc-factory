...
public class EnabledButton extends ImageButton {
    ...
    @Override
    public void renderWidget(MatrixStack p_230431_1_, int p_renderButton_1_, int p_renderButton_2_, float p_renderButton_3_) {
        ...
        blit(p_230431_1_, x, y, textureX, textureY, width, height, 256, 256);
